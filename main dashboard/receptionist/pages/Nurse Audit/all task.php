...
// for all task list
$task_list_sql_All = "SELECT * FROM `nurse_audit_tasks`";
$task_list_query_ALl = mysqli_query($conn,$task_list_sql_All);
$task_list_num_rows_All = mysqli_num_rows($task_list_query_ALl);
...
// active task and all task
$active_task_display = "block";
$all_task_display = "none";
if(isset($_GET['displayAll_Task']) && $_GET['displayAll_Task']==1){
  $all_task_display = "block";
  $active_task_display = "none";
}

if(isset($_GET['displayActiveTask']) && $_GET['displayActiveTask']==1){
  $all_task_display = "none";
  $active_task_display = "block";
}
      ...
      <div class="container-fluid page-body-wrapper" style="display: flex;">
        ...
        <div class="main-panel">
            <div  class="content-wrapper">
                ...
                <?php
                  if($conn){
                    ...
                    if(isset($_POST['searcBTN'])){
                      ...
                      if($searchValue!=""){
                        $search_sql = "SELECT * FROM `nurse_audit_tasks` WHERE id=$searchValue";
                ...
                ?>
                          <br>
                          <h4>Search Result <?php echo $search_num_rows; ?> out of <?php echo $task_list_num_rows_All; ?></h4>
                          <div class="table-responsive">
                            <table class="table table-striped">
                              ...
                              <tr>
                                  ...
                                  <td>
                                    <?php
                                      if ( $search_fetch_assoc['stauts']=="active" ){
                                        echo ' <i class="fa-solid fa-circle fa-lg" style="color: #3dbd4c;"></i> ';
                                      }else{
                                        echo ' completed ';
                                      }
                                  ...
                                  <td> <img src="../Patient/patient photos/<?php echo $search_fetch_assoc['task_user_img'] ?>" > </td>
                                  <td><?php echo $search_fetch_assoc['task_full_name'] ?></td>
                                  <td><?php echo $search_fetch_assoc['task_referring_by'] ?></td>
                                  <td><?php echo $search_fetch_assoc['task_reason'] ?></td>
                                  <td><?php echo $search_fetch_assoc['task_Sex'] ?></td>
                                  <td><?php echo $search_fetch_assoc['task_Blood_Group'] ?></td>
                                  <td><?php echo $search_fetch_assoc['task_Room_Number'] ?></td>
                                  <td><?php echo $search_fetch_assoc['medicines'] ?></td> 
                                  <td><?php echo $search_fetch_assoc['task_date'] ?></td>
                                  <td>
                          ...
                          <a href="http://localhost/my%20hospital/main%20dashboard/receptionist/pages/Nurse%20Audit/all%20task.php" class="btn btn-primary">Clear Search</a><br><br><br>
                <?php
                        }else{
...
<!-- all task list -->
<div style="display: <?php echo $all_task_display; ?> ;">
              <table  id="all_task_list_Table" class="table table-striped">
                
                <a href="?displayActiveTask=1" class="btn btn-primary" role="button">Active Task</a>
                <br><br>
                <h3> Total Task : <b><?php echo $task_list_num_rows_All; ?></b></h3>
                <thead>
                  <tr>
                    <th>#</th>
                    <th>Status</th>
                ...
                <tbody>
                  ...
                  while ($task_list_fetch_All = mysqli_fetch_assoc($task_list_query_ALl)){
                    if($task_list_fetch_All['stauts']=='active'){
                      $active_= '<i class="fa-solid fa-circle fa-lg" style="color: #3dbd4c;"></i>';
                    }else{
                      $active_='Completed';
                    }
                  ...
                  ?>
                    ...
                    <tr>
                      ...
                      <td> <?php echo $active_; ?> </td>
                      <td> <img src="../Patient/patient photos/<?php echo $task_list_fetch_All['task_user_img'] ?>" > </td>
...
<!-- active task list -->
 <div style="display: <?php echo $active_task_display; ?>;">             
              <table  class="table table-striped">
                <br>
                <a href="?displayAll_Task=1" class="btn btn-primary" role="button">All Task</a>
                <br><br>
                <h4> Active Task : <b><?php echo $task_list_num_rows_active; ?></b> </h4>
                ...
                <tbody>
                  ...
                  while ($task_list_fetch_assoc = mysqli_fetch_assoc($task_list_query_active)){

                  ?>

                    <tr>
                      <td><?php echo $task_list_fetch_assoc['id'] ?></td>
                      <td><i class="fa-solid fa-circle fa-lg" style="color: #3dbd4c;"></i></td>
                      <td> <img src="../Patient/patient photos/<?php echo $task_list_fetch_assoc['task_user_img'] ?>" > </td>
                      <td><?php echo $task_list_fetch_assoc['task_full_name'] ?></td>
                      <td><?php echo $task_list_fetch_assoc['task_referring_by'] ?></td>
                      <td><?php echo $task_list_fetch_assoc['task_reason'] ?></td>
                      <td><?php echo $task_list_fetch_assoc['task_Sex'] ?></td>
                      <td><?php echo $task_list_fetch_assoc['task_Blood_Group'] ?></td>
                      <td><?php echo $task_list_fetch_assoc['task_Room_Number'] ?></td>
                      <td><?php echo $task_list_fetch_assoc['medicines'] ?></td> 
                      <td><?php echo $task_list_fetch_assoc['task_date'] ?></td>
                      <td>
                        <button type="button" class="btn btn-primary btn-sm btn-edit">Edit</button>
                        <button type="button" class="btn btn-danger btn-sm btn-delete">Delete</button>
                      </td>
